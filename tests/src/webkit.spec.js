...
test(`Invalid Sign In Attempt - webkit`, async () => {
  test.setTimeout(60000);
  const browser = await webkit.launch();
  const page = await browser.newPage();
  await page.goto(CLIENT_URL);
...
test(`projects button goes to projects dashboard - webkit`, async () => {
  test.setTimeout(60000);
  const browser = await webkit.launch();
  const page = await browser.newPage();
  await page.goto(CLIENT_URL);
...
test(`students button goes to students dashboard - webkit`, async () => {
  test.setTimeout(60000);
  const browser = await webkit.launch();
  const page = await browser.newPage();
  await page.goto(CLIENT_URL);
...
test(`home button goes back to home dashboard - webkit`, async () => {
  test.setTimeout(60000);
  const browser = await webkit.launch();
  const page = await browser.newPage();
  await page.goto(CLIENT_URL);
...
test(`assessments button goes to assessments dashboard - webkit`, async () => {
  test.setTimeout(60000);
  const browser = await webkit.launch();
  const page = await browser.newPage();
  await page.goto(CLIENT_URL);
...
test(`change cohorts from the modal - webkit`, async () => {
  test.setTimeout(60000);
  const browser = await webkit.launch();
  const page = await browser.newPage();
  await page.goto(CLIENT_URL);
