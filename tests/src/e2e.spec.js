...
// for (const browserName of browsers) {
  ...
  test(`home button goes back to home dashboard - `, async ({ page }) => {
    ...
    console.log('testing');
    const isVisible = await page.isVisible("button", { name: "Add Student" });
    expect(isVisible).toBe(true);
    // const elementHandle = await page.$('#students');
    // await elementHandle.click();
    // console.log('testing');
    // console.log('testing');
    // await page.getByRole("div", { name: "Menu" }).click();
    // console.log('testing');
    // await page.getByRole("li", { name: "Home" }).click();
    // console.log('testing');
    // const dashboard = await page.isVisible("div", { name: "Home Dashboard" });
